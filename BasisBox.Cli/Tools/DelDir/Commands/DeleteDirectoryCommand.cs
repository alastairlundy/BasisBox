...
public class DeleteDirectoryCommand : Command<DeleteDirectoryCommand.Settings>
{
    ...
    public override int Execute(CommandContext context, Settings settings)
    {
        ...
        {
            AnsiConsole.WriteException(new ArgumentNullException(nameof(settings.DirectoryToBeDeleted), Resources.Exceptions_NoArgumentsProvided), exceptionFormats);
            return -1;
        }
        ...
        try
        {
            ...
            {
                throw new DirectoryNotFoundException(Resources.Exceptions_DirectoryNotFound.Replace("{x}", settings.DirectoryToBeDeleted));
            }
        }
